...
//        listTest2();
    ...
    public static void listTest() {
        ...
        //查询对象所在集合中的下标
        System.out.println("查询该值在集合中的下标" + list.indexOf(list1));
        //返回集合中fromIndex（包括）到toIndex（不包括）中间的内容
    ...
    public static void listTest2() {
        ...
        //iterator.nextIndex()下一个元素的索引
        while (iterator.hasNext()) {
            System.out.println(iterator.next() + "--index--" + iterator.nextIndex());
        }
        //iterator.previousIndex()上一个元素的索引
        while (iterator.hasPrevious()) {
