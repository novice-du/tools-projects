...
public class Barrs_1 {
	...
	public Barrs_1(){
		...
		try {
			images[0] = ImageIO.read(new File("F:/PersonalProject/run-day/run-day/image/a4.png"));
			images[1] = ImageIO.read(new File("F:/PersonalProject/run-day/run-day/image/a2.png"));
		} catch (IOException e) {
