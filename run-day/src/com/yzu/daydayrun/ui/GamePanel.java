...
public class GamePanel extends JPanel implements KeyListener {
	...
	public GamePanel() {
		...
		pet = new Pet(person);
		background = new ImageIcon("F:/PersonalProject/run-day/run-day/image/mainBg.png").getImage();

		showfield = new ImageIcon("F:/PersonalProject/run-day/run-day/image/fieldinfo.png").getImage();

		distancefield = new ImageIcon("F:/PersonalProject/run-day/run-day/image/fieldinfo.png").getImage();
	}
